...
$env:NO_PROXY='*'
$env:Path = "C:\____PETR_AI\MECH_RAG\lightrag\.venv-rag\Scripts;$env:Path"   # raganything checks `mineru --version` on PATH
$env:PYTHONIOENCODING='utf-8'
$env:MINERU_DEVICE_MODE='cuda'
# REQUIRED: stop server first — script writes the same storage files as the container
docker compose stop
& "C:\____PETR_AI\MECH_RAG\lightrag\.venv-rag\Scripts\python.exe" rag_ingest.py "C:\path\to\document.pdf"
...
- If rag_ingest.py is missing, tell the user setup step 5 of C:\____PETR_AI\MECH_RAG\INSTALL_NEW_COMPUTER.md is incomplete.